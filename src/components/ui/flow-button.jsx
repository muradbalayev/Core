...
export  function FlowButton({ text = "Modern Button" }) {
  return (
    <button className="group relative flex items-center gap-1 overflow-hidden rounded-full border-[1.5px] border-[#333333]/30 bg-transparent px-8 py-2 text-sm font-semibold text-[#111111] cursor-pointer transition-all duration-[600ms] ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-transparent hover:text-white  active:scale-[0.95]">
      {/* Left arrow (arr-2) */}
      {/* <ArrowRight 
