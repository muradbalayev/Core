...
export  function FlowButton({ text = "Modern Button" }) {
  return (
    <button className="group relative flex items-center gap-1 overflow-hidden rounded-full border-[1.5px] border-[#333333]/30 bg-transparent px-6 sm:px-8 sm:py-2 py-1.5 sm:text-sm text-[12px] font-semibold text-[#111111] cursor-pointer transition-all duration-[600ms] ease-[cubic-bezier(0.23,1,0.32,1)] hover:border-transparent hover:text-white  active:scale-[0.95]">
      {/* Left arrow (arr-2) */}
      {/* <ArrowRight 
      ...
      {/* Text */}
      <span className="relative text-base z-[1] group-hover:text-white transition-all duration-[800ms] ease-out">
        {text}
      </span>
